...
<div class="container-fluid">
                        ...
                        <div>
                            <ul class="nav justify-content-end">
                                <li class="nav-item"><a class="nav-link active"
                                                        aria-current="page"
                                                        href="<%=request.getContextPath()%>/pageAccueil">Enchères</a>
                                </li>
                                <li class="nav-item"><a class="nav-link"
    ...
    <div class="card">
        <div class="card-body">
            <div action="/pageAccueil" method="post">
                <div class="row mb-2">
...
<div class="container-fluid">
    <div class="row">
        ...
        <c:forEach var="articleVendu" items="${articles}">
            ...
            <div class="card m-2 mx-auto h-100 shadow-sm"
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-7">
                        <div class="card-body text-center">
                            ...
                            <a href="<%=request.getContextPath()%>/detailVente?param1=${modeConnecte }&param2=${articleVendu.noArticle}"
