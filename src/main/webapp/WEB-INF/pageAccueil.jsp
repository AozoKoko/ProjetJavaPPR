...
=======
		<div class="form-outline">
			<div class="row mb-2">
				...
				<div class="col-md-9">
					<button class="btn btn-outline-dark">
						<label classe for="recherche" style="height: 100px">
							Rechercher </label>
					</button>
				</div>
>>>>>>> branch 'main' of https://github.com/AozoKoko/ProjetJavaPPR.git
			</div>
		</div>
<<<<<<< HEAD
	</div>
...
=======
		...
		<br> <label class="form-label" for="genreImput">
			Catégorie : </label> <select class="form-control-sm ml-3 w-75" name="genre"
			id="" value="a">
